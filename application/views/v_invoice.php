...
<div style="
    background: url(https://ecs7.tokopedia.net/img/invoice/paid-stamp.png) center no-repeat;
    ...
    <table class="container" style="width: 790px; padding: 20px;" width="790" cellspacing="0" cellpadding="0">
        <tbody><tr>
            <td>
                <table style="width: 100%; padding-bottom: 20px;" width="100%" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr style="margin-top: 8px; margin-bottom: 8px;">
                            <td>
                                <img src="<?php echo base_url('assets/coloshop/images/new_logo.png'); ?>" alt="Tokopedia">
                            </td>
                            <td style="text-align: right; padding-right: 15px;">
                                <a style="color: #42B549; font-size: 14px; text-decoration: none;" href="javascript:window.print()">
                                    ...
                                    <img src="<?php echo base_url('assets/coloshop/images/print.png'); ?>" alt="Print" style="vertical-align: middle;">
                                </a>
                            </td>
                        </tr>
                    </tbody>
                                            ...
                                            <table style="width: 100%; border-collapse: collapse;" width="100%" cellspacing="0" cellpadding="0">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="padding: 3px 0;">INV/20180108/XVIII/I/127598592</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                ...
                <table style="width: 100%; padding: 0 0 20px;" width="100%" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
